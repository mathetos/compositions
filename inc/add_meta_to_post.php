...
function compositions_load_before_content() {
    if ( file_exists(  COMPOSITIONS_DIR . '/template_parts/before_content.php' ) )
        include( COMPOSITIONS_DIR . '/template_parts/before_content.php' );
}

function compositions_load_after_content() {
    if ( file_exists(  COMPOSITIONS_DIR . '/template_parts/after_content.php' ) )
        include( COMPOSITIONS_DIR . '/template_parts/after_content.php');
}
